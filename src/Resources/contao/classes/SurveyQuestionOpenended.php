...
class SurveyQuestionOpenended extends SurveyQuestion
{
    ...
    protected function exportDetailResults(& $exporter, $sheet, & $row, & $col, $participants)
    {
        ...
        foreach ($participants as $key => $value) {
            ...
            if (isset($this->statistics['participants']) && isset($this->statistics['participants'][$key]['result']) && \strlen($this->statistics['participants'][$key]['result'])) {
                // future state of survey_ce
                $data = $this->statistics['participants'][$key]['result'];
            } elseif (isset($this->statistics['participants']) && isset($this->statistics['participants'][$key][0]['result']) && \strlen($this->statistics['participants'][$key][0]['result'])) {
