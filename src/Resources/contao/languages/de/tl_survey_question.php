...
$GLOBALS['TL_LANG']['tl_survey_question']['openended_cols']= ['Spalten';
...
$GLOBALS['TL_LANG']['tl_survey_question']['openended_width']= ['Breite';
...
$GLOBALS['TL_LANG']['tl_survey_question']['multiplechoice_subtype']= ['Untertyp';
...
$GLOBALS['TL_LANG']['tl_survey_question']['matrix_subtype']= ['Untertyp';
$GLOBALS['TL_LANG']['tl_survey_question']['matrix_subtype']['1'] = 'Bitte wählen Sie den Untertyp für die Matrixfrage aus.';
$GLOBALS['TL_LANG']['tl_survey_question']['matrixrows']= ['Zeilen';
...
$GLOBALS['TL_LANG']['tl_survey_question']['matrixcolumns']= ['Spalten';
...
$GLOBALS['TL_LANG']['tl_survey_question']['addneutralcolumn']= ['Neutrale Spalte erlauben';
...
$GLOBALS['TL_LANG']['tl_survey_question']['neutralcolumn']= ['Neutrale Spalte';
$GLOBALS['TL_LANG']['tl_survey_question']['neutralcolumn']['1'] = 'Bitte geben Sie einen Text für die neutrale Spalte ein.';
$GLOBALS['TL_LANG']['tl_survey_question']['addbipolar']= ['Entgegengesetzte Pole anzeigen';
...
$GLOBALS['TL_LANG']['tl_survey_question']['sum']= ['Summe';
...
$GLOBALS['TL_LANG']['tl_survey_question']['sumoption']= ['Berechnungsoption';
...
$GLOBALS['TL_LANG']['tl_survey_question']['inputfirst']= ['Eingabefelder vor den Antworten anzeigen';
